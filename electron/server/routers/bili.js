...
import { SignParamsWbi, copyright_dict, state_dict } from "../utils/bilibili.js";
...
router.get("/dynamics",async(req,res)=>{
    try{
        ...
        requests.get("/x/polymer/web-dynamic/v1/feed/space", {
...
router.get('/member/archives/xcode_msg',async(req,res)=>{
    try{
        requests.get("/x/web/archive/failcode", {
            params: {
                bvid: req.query.bvid
            },
            baseURL: "https://member.bilibili.com",
...
router.get('/qrcode/fetch',async(req,res)=>{
    try{
        axios.get('/x/passport-login/web/qrcode/generate',{
...
router.get('/qrcode/pool',async(req,res)=>{
    try{
        ...
        axios.get("/x/passport-login/web/qrcode/poll", {
            baseURL: "https://passport.bilibili.com",
